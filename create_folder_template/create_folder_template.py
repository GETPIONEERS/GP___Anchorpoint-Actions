...
dialog.add_info("Sets default icons and colors after creating the folders. This should be enabled in most cases.")
dialog.add_empty()
dialog.add_info("Warning: Anchorpoint will freeze for a couple of seconds. This is normal.")
